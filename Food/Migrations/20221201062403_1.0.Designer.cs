            ...
            modelBuilder.Entity("Food.Entity.Bills", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            bill_DatetimeOrder = new DateTime(2022, 12, 1, 13, 24, 2, 712, DateTimeKind.Local).AddTicks(3086),
            ...
            modelBuilder.Entity("Food.Entity.Categories", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            cg_Id = "5d05272c-92e5-4012-9b8a-7352ccabb561",
                            cg_Name = "Dry food",
                            cg_Sale = "",
                            cg_Type = ""
                        },
                        new
                        {
                            cg_Id = "9867fd9e-0d12-4f4f-b0c9-937c949d29c7",
                            cg_Name = "Food",
                            cg_Sale = "",
                            cg_Type = ""
                        },
                        new
                        {
                            cg_Id = "8687b07e-038b-43a0-8f6c-40825656e492",
                            cg_Name = "Drink",
                            cg_Sale = "",
                            cg_Type = ""
                        },
                        new
                        {
                            cg_Id = "22d2f0de-4b82-4de3-be7f-c1023398fbfe",
                            cg_Name = "Banhmi",
                            cg_Sale = "",
                            cg_Type = ""
                        },
                        new
                        {
                            cg_Id = "747961a5-c868-4f46-aeb0-8e43ec8a4ee7",
                            cg_Name = "Snack",
                            cg_Sale = "",
                            cg_Type = ""
                        });
            ...
            modelBuilder.Entity("Food.Entity.ContactSystem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Contact_Id = "ccf09f19-a11c-497f-9e93-f574fc1f9468",
            ...
            modelBuilder.Entity("Food.Entity.ContactUsers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            cu_Id = "c0c31443-5360-47e0-a28c-0f5a38deedfd",
            ...
            modelBuilder.Entity("Food.Entity.Coupons", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            couponId = "7ca3df06-5ddc-4be8-bfed-08ad6b74e2a9",
                            couponCode = "code10",
                            couponPrice = 10
                        },
                        new
                        {
                            couponId = "77f08e2d-e167-49ef-bb27-beba332a92a3",
                            couponCode = "code50",
                            couponPrice = 50
                        });
                });
            ...
            modelBuilder.Entity("Food.Entity.Products", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            pd_Id = "40540fc0-ee18-44e5-932f-fbec03452ca7",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "960f6e91-244c-4d49-8f55-fdc2bd9a1ee8",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "c4035cec-6b81-4430-937c-86a0f27312ad",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "60555bef-ded6-4b92-83e3-97e8c46f0d71",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "7e72cc5f-67f2-4b7c-a69b-29c2b69154cf",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "cdd46832-ad85-446b-8e0c-82fa5e2da987",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "0a29137b-8769-4c6c-a7eb-3bf84022a857",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "ed5e7364-9d0f-46ba-8e18-84c0a272e66c",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "413442aa-2f9f-4a31-bfec-caa3b4c17c48",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "4873b3ff-0e1b-4ddb-9600-ac6092ac6c51",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "af354cdd-d715-4937-873a-6680ad908f56",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "73b0edc3-9413-4bf4-a1df-70268447264d",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "ddbafbfe-fd40-44bd-b338-4825f7946c01",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "0f67950f-e914-4bae-95f8-40c4fd73375c",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "b2289829-9410-4074-9f99-3e4a93ec19e8",
                            isDelete = false,
                            pd_Description = "kfc",
                        ...
                        new
                        {
                            pd_Id = "d34000ff-a72a-462e-9c37-5cb0405d01f3",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "678e5914-dc06-4d15-94fc-bb22c2996a5c",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "37493c5e-e014-4b79-b39e-74e968863127",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "66eaa150-c9b5-4bf3-8ae0-d7bde5e53116",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "658da0b6-b8ad-4a37-ac6e-628581ed3742",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "922899af-be3a-4046-9124-eeac5be5d06d",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "2b618658-c78a-4c0e-8bf2-2f0c1570920e",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "c66d3d35-d292-4adb-8412-fcf970f584b6",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "d7ea2327-f5cc-4eae-990f-fbd35616ad4f",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "cbfd0aa8-a64d-438a-85be-4464374e5e73",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "413ad81f-bbb2-41de-89f8-3fd701b2d8d6",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "c543626b-1591-4f0c-a1ca-370649ee64e9",
                            isDelete = false,
                        ...
                        new
                        {
                            pd_Id = "8226a07a-4dbf-4d5d-94c4-ababa52ea246",
                            isDelete = false,
            ...
            modelBuilder.Entity("Food.Entity.ProductsInCategories", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            pic_productId = "0a29137b-8769-4c6c-a7eb-3bf84022a857",
                            pic_CategoriesId = "5d05272c-92e5-4012-9b8a-7352ccabb561"
                        },
                        new
                        {
                            pic_productId = "ed5e7364-9d0f-46ba-8e18-84c0a272e66c",
                            pic_CategoriesId = "5d05272c-92e5-4012-9b8a-7352ccabb561"
                        },
                        new
                        {
                            pic_productId = "4873b3ff-0e1b-4ddb-9600-ac6092ac6c51",
                            pic_CategoriesId = "5d05272c-92e5-4012-9b8a-7352ccabb561"
                        },
                        new
                        {
                            pic_productId = "af354cdd-d715-4937-873a-6680ad908f56",
                            pic_CategoriesId = "5d05272c-92e5-4012-9b8a-7352ccabb561"
                        },
                        new
                        {
                            pic_productId = "73b0edc3-9413-4bf4-a1df-70268447264d",
                            pic_CategoriesId = "5d05272c-92e5-4012-9b8a-7352ccabb561"
                        },
                        new
                        {
                            pic_productId = "ddbafbfe-fd40-44bd-b338-4825f7946c01",
                            pic_CategoriesId = "5d05272c-92e5-4012-9b8a-7352ccabb561"
                        },
                        new
                        {
                            pic_productId = "0f67950f-e914-4bae-95f8-40c4fd73375c",
                            pic_CategoriesId = "5d05272c-92e5-4012-9b8a-7352ccabb561"
                        },
                        new
                        {
                            pic_productId = "d34000ff-a72a-462e-9c37-5cb0405d01f3",
                            pic_CategoriesId = "5d05272c-92e5-4012-9b8a-7352ccabb561"
                        },
                        new
                        {
                            pic_productId = "40540fc0-ee18-44e5-932f-fbec03452ca7",
                            pic_CategoriesId = "9867fd9e-0d12-4f4f-b0c9-937c949d29c7"
                        },
                        new
                        {
                            pic_productId = "60555bef-ded6-4b92-83e3-97e8c46f0d71",
                            pic_CategoriesId = "9867fd9e-0d12-4f4f-b0c9-937c949d29c7"
                        },
                        new
                        {
                            pic_productId = "7e72cc5f-67f2-4b7c-a69b-29c2b69154cf",
                            pic_CategoriesId = "9867fd9e-0d12-4f4f-b0c9-937c949d29c7"
                        },
                        new
                        {
                            pic_productId = "cdd46832-ad85-446b-8e0c-82fa5e2da987",
                            pic_CategoriesId = "9867fd9e-0d12-4f4f-b0c9-937c949d29c7"
                        },
                        new
                        {
                            pic_productId = "66eaa150-c9b5-4bf3-8ae0-d7bde5e53116",
                            pic_CategoriesId = "9867fd9e-0d12-4f4f-b0c9-937c949d29c7"
                        },
                        new
                        {
                            pic_productId = "c66d3d35-d292-4adb-8412-fcf970f584b6",
                            pic_CategoriesId = "8687b07e-038b-43a0-8f6c-40825656e492"
                        },
                        new
                        {
                            pic_productId = "d7ea2327-f5cc-4eae-990f-fbd35616ad4f",
                            pic_CategoriesId = "8687b07e-038b-43a0-8f6c-40825656e492"
                        },
                        new
                        {
                            pic_productId = "413ad81f-bbb2-41de-89f8-3fd701b2d8d6",
                            pic_CategoriesId = "8687b07e-038b-43a0-8f6c-40825656e492"
                        },
                        new
                        {
                            pic_productId = "c543626b-1591-4f0c-a1ca-370649ee64e9",
                            pic_CategoriesId = "8687b07e-038b-43a0-8f6c-40825656e492"
                        },
                        new
                        {
                            pic_productId = "960f6e91-244c-4d49-8f55-fdc2bd9a1ee8",
                            pic_CategoriesId = "22d2f0de-4b82-4de3-be7f-c1023398fbfe"
                        },
                        new
                        {
                            pic_productId = "37493c5e-e014-4b79-b39e-74e968863127",
                            pic_CategoriesId = "22d2f0de-4b82-4de3-be7f-c1023398fbfe"
                        },
                        new
                        {
                            pic_productId = "c4035cec-6b81-4430-937c-86a0f27312ad",
                            pic_CategoriesId = "747961a5-c868-4f46-aeb0-8e43ec8a4ee7"
                        },
                        new
                        {
                            pic_productId = "413442aa-2f9f-4a31-bfec-caa3b4c17c48",
                            pic_CategoriesId = "747961a5-c868-4f46-aeb0-8e43ec8a4ee7"
                        },
                        new
                        {
                            pic_productId = "b2289829-9410-4074-9f99-3e4a93ec19e8",
                            pic_CategoriesId = "747961a5-c868-4f46-aeb0-8e43ec8a4ee7"
                        },
                        new
                        {
                            pic_productId = "678e5914-dc06-4d15-94fc-bb22c2996a5c",
                            pic_CategoriesId = "747961a5-c868-4f46-aeb0-8e43ec8a4ee7"
                        },
                        new
                        {
                            pic_productId = "658da0b6-b8ad-4a37-ac6e-628581ed3742",
                            pic_CategoriesId = "747961a5-c868-4f46-aeb0-8e43ec8a4ee7"
                        },
                        new
                        {
                            pic_productId = "922899af-be3a-4046-9124-eeac5be5d06d",
                            pic_CategoriesId = "747961a5-c868-4f46-aeb0-8e43ec8a4ee7"
                        },
                        new
                        {
                            pic_productId = "2b618658-c78a-4c0e-8bf2-2f0c1570920e",
                            pic_CategoriesId = "747961a5-c868-4f46-aeb0-8e43ec8a4ee7"
                        },
                        new
                        {
                            pic_productId = "cbfd0aa8-a64d-438a-85be-4464374e5e73",
                            pic_CategoriesId = "747961a5-c868-4f46-aeb0-8e43ec8a4ee7"
                        },
                        new
                        {
                            pic_productId = "8226a07a-4dbf-4d5d-94c4-ababa52ea246",
                            pic_CategoriesId = "747961a5-c868-4f46-aeb0-8e43ec8a4ee7"
                        });
                });
            ...
            modelBuilder.Entity("Food.Entity.ReviewInproduct", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            rip_ProductId = "40540fc0-ee18-44e5-932f-fbec03452ca7",
            ...
            modelBuilder.Entity("Food.Entity.SubReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            subReview_Id = "ffa68b47-0100-46b7-ae56-aad0fb5baec5",
                        ...
                        new
                        {
                            subReview_Id = "b51c5fab-191d-4340-ba6d-409307a82b7d",
                        ...
                        new
                        {
                            subReview_Id = "0f66089b-4172-4437-a867-2bb169c58e0f",
                            subReview_Commnet = "subreview 3",
                            subReview_DateCommnet = new DateTime(2020, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            subReview_HideStatus = false,
                            subReview_UserId = "DE544998-A3CC-4E12-ABB4-0642E57BD222",
            ...
            modelBuilder.Entity("Food.Entity.SubReviewInReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SRiR_SubReviewId = "ffa68b47-0100-46b7-ae56-aad0fb5baec5"
                        },
                        new
                        {
                            SRiR_ReviewId = "EEBA6608-AB75-4E83-909F-604B1A06F16C",
                            SRiR_SubReviewId = "b51c5fab-191d-4340-ba6d-409307a82b7d"
                        },
                        new
                        {
                            SRiR_ReviewId = "9EED8607-D2BB-45EE-AEE3-C59D858A7F97",
                            SRiR_SubReviewId = "0f66089b-4172-4437-a867-2bb169c58e0f"
                        });
                });
            ...
            modelBuilder.Entity("Food.Entity.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "008a2cf1-8332-4119-8b3a-7fbf1f53b710",
                            Name = "Staff",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "74ec700a-1157-43f2-8260-ac544524a22f",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Food.Entity.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5d7ace04-e5e6-478b-a6df-fb0615fd889c",
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEAdwYA5j+a8vhy5ZbDQ0O3pG4DWsBMUu0wV5145y6EB6oZ+4LXUxrTNoSKAmuvHqGA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "0edcbff6-3e24-4518-b8e0-e0ef99b4c9af",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e38a22b9-3916-4d90-9460-c13fa486ecf9",
                            Email = "staff@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "STAFF@GMAIL.COM",
                            NormalizedUserName = "STAFF@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEBq6UwhYMWHg8S0sWkDcaSTlD36zXDsCqGwfxQFf4SB884eWiPF5GkgjquGxcTKhrg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "4d5e417c-0fde-46e5-bc88-34fd153c23a8",
                            TwoFactorEnabled = false,
                            UserName = "Staff",
